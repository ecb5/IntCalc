...
},
{
  ...
  "number": "2.2.2.8",
  "title": "",
  "body": " Confirm that equation is correct by getting a common denominator and adding the terms on the right together.  "
},
{
...
{
  "id": "SUBSUBSECTIONPFDIrreducQuadFac-14",
  "level": "2",
  "url": "SECTIONPartFrac.html#SUBSUBSECTIONPFDIrreducQuadFac-14",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SUBSUBSECTIONPFDIrreducQuadFac-16",
  "level": "2",
  "url": "SECTIONPartFrac.html#SUBSUBSECTIONPFDIrreducQuadFac-16",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "complex real complex numbers Euler s Identity "
},
{
  "id": "SUBSUBSECTIONPFDIrreducQuadFac-17",
  "level": "2",
  "url": "SECTIONPartFrac.html#SUBSUBSECTIONPFDIrreducQuadFac-17",
  "type": "Example",
  "number": "2.2.2.10",
  "title": "",
  "body": " Suppose we want to decompose the rational function . There are no real numbers, and , with the property that but and (where as before ) will work just fine since .  Thus we can use the HCUM to compute .  But, unfortunately, in this course we confine our attention to the real numbers and treat the complex numbers as a guilty secret, even when using them would make more sense. To get the decomposition back into just the real number we compute the sum as follows . Thus our decompostion over the real numbers (rather than the complex numbers is .  "
},
{
  "id": "SUBSUBSECTIONPFDIrreducQuadFac-18",
  "level": "2",
  "url": "SECTIONPartFrac.html#SUBSUBSECTIONPFDIrreducQuadFac-18",
  "type": "Problem",
  "number": "2.2.2.11",
  "title": "",

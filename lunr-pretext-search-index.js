...
{
  "id": "SECTIONProbs13-16",
  "level": "2",
  "url": "SECTIONProbs13.html#SECTIONProbs13-16",
  "type": "Problem",
  "number": "5.38",
  "title": "",
  "body": " Suppose is unbounded at the left endpoint of the interval . Provide a similar way to compute the improper integral .   Apply your technique from part a to compute the following improper integrals.    Plot these two curves on the same set of axes for . Staring at these graphs, are you surprised by the results in part b?  "
},
{
...
},
{
  ...
  "number": "5.40",
  "title": "",
  "body": " Use an improper integral with volumes of disks to obtain Torricelli s result. Again, it should be noted that Torricelli obtained this before the invention of calculus.   Actually, if we use cylindrical shells, this will actually be closer to what Torricelli did and will not involve an improper integral. Do this.  "
},
{

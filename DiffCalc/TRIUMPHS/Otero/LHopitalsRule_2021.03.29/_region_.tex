\message{ !name(LHopitalsRule_2021.03.29.tex)}\documentclass[11pt]{article}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%IMPORTANT NOTES:                                                                                                                                       %%
%% 1.  This Template file is designed for use by authors of TRIUMPHS PSPs.                                                                               %%
%% 2. THIS TEMPLATE FILE WILL NOT PROPERLY COMPILE without access (in the same file directory) to the Creative Commons BY-SA logo (see line #267 below). %%

%% 3. FOR A STUDENT-ONLY VERSION OF THIS PSP (which omits the Notes to Instructors section), remove the % from the beginning of line #179.               %%
...
\message{ !name(LHopitalsRule_2021.03.29.tex) !offset(-3) }


\title{L'H\^opital's Rule}
\author{Daniel E.~Otero\thanks{Department of Mathematics, Xavier University, Cincinnati, OH, 45207-4441; \texttt{otero@xavier.edu}.
}}
\date{March 29, 2021}
\bigskip
...
\message{ !name(LHopitalsRule_2021.03.29.tex) !offset(-621) }
